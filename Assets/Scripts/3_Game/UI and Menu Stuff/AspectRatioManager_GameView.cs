...
public class AspectRatioManager_GameView : MonoBehaviour
{
    ...
    public GameObject woodenBench_long;
    public GameObject woodenBench_shorter;

    private Camera mainCam;

    private float aspectRatio_wDivH;

    private const float normalLongerFOV = 90f;
    ...
    private void changeUI_portrait_forTallerPhones()
    {
        ...
        woodenBench_long.SetActive(true);
        woodenBench_shorter.SetActive(false);
    ...
    private void changeUI_landscape_forTablets()
    {
        ...
        woodenBench_long.SetActive(false);
        woodenBench_shorter.SetActive(true);
