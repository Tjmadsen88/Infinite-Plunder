...
{
    public class InteractableObject_Collectable : InteractableObject_Abstract
    {
        private WakeController_Stationary wakeController;
        private float moveAmount = 0f;
        private float chainDist = 0f;

        public InteractableObject_Collectable(GameObject objectPrefab, byte objectID, short objectOrder)
        {
